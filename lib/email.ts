...
const FROM = process.env.EMAIL_FROM || 'TaxWise1099 - Financial planning platform for W-2 to 1099 employment transitions <noreply@example.com>';
const APP_NAME = 'TaxWise1099 - Financial planning platform for W-2 to 1099 employment transitions';
