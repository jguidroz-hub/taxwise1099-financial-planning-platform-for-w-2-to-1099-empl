  ...
  try {
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="TaxWise1099 - Financial planning platform for W-2 to 1099 employment transitions-export-${new Date().toISOString().split('T')[0]}.json"`,
      },
    });
  } catch (error: any) {
